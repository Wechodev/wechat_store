    ...
    public function show_js($link_module) {
       ...
       //$url            =   rtrim(__APP__.'/'.$module_name.C('URL_PATHINFO_DEPR').$action_name.C('URL_PATHINFO_DEPR').$parameter,C('URL_PATHINFO_DEPR'));
        ...
        $pageStr	 =	 str_replace(
         ...
         $pageStr.="<input type='text' class='txtpage' id='_tz_page_' value='".$this->nowPage."' /><input type='button' value='跳转' class='txtbtn' onclick='".$link_module."(document.getElementById(\"_tz_page_\").value)' />";     
        return $pageStr;
    }
